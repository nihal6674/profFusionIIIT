        ...
        {isAcademicsOpen && (
          <ul className="ml-6">
            <li className="mb-3 cursor-pointer hover:text-blue-500 flex items-center">
              <Link to="/assigned-courses" className="flex items-center">
                <FaCheckCircle className="mr-2" /> Assigned Courses
              </Link>
            </li>
            <li className="mb-3 cursor-pointer hover:text-blue-500 flex items-center">
              <Link to="/course-management" className="flex items-center">
                <FaClipboardList className="mr-2" /> Course Management
              </Link>
            </li>
            <li className="mb-3 cursor-pointer hover:text-blue-500 flex items-center">
              <Link to="/submit-marks" className="flex items-center">
                <FaCheckCircle className="mr-2" /> Submit Marks
              </Link>
            </li>
            <li className="mb-3 cursor-pointer hover:text-blue-500 flex items-center">
              <Link to="/combined-assistantship" className="flex items-center">
                <FaClipboardList className="mr-2" /> View Roll List
              </Link>
            </li>
          </ul>
        )}
